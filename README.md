...
gr.TabbedInterface([
    ...
    gr.Interface(YMT3(hf_hub_download("shethjenil/Audio2Midi_Models",f"{getenv("crepe_model_capacity","YMT3+")}.pt"),getenv("yourmt3_model_type","YMT3+"),"32" if str(device) == "cpu" else "16",device).predict,gr.gr.Audio(label="Input Audio",type="filepath"),gr.File(label="MIDI File")),
    midi_viz_ui
